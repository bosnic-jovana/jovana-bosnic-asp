...
namespace Resturant.Api.Controllers
{
    ...
    public class SpecialtiesController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] EditSpecialtyDto dto,
            [FromServices] IEditSpecialtyCommand command)
        {
            dto.Id = id;
            _handler.HandleCommand(command, dto);
            return NoContent();
        ...
        [HttpDelete("{id}")]
        public IActionResult Delete(int id, [FromServices] IDeleteSpecialtyCommand command)
        {
