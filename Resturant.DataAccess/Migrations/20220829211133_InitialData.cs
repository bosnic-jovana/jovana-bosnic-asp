        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pricelists_Specialities_SpecialtyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialtyIngredients", x => new { x.SpecialtyId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_SpecialtyIngredients_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpecialtyIngredients_Specialities_SpecialtyId",
                        column: x => x.SpecialtyId,
                        principalTable: "Specialities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => new { x.PricelistId, x.OrderId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Pricelists_PricelistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pricelists_SpecialtyId",
                table: "Pricelists",
                column: "SpecialtyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialtyIngredients_IngredientId",
                table: "SpecialtyIngredients",
                column: "IngredientId");
